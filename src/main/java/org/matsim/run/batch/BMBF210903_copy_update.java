 ...
 * bmbf runs
 */
public class BMBF210903_copy_update implements BatchRun<BMBF210903_copy_update.Params> {
...
//		eduTestsPCR.put(LocalDate.parse("2021-08-06"), 0.1);
	...
	public static final class Params {
		...
		@Parameter({0.8, 0.9, 1.0, 1.05, 1.1, 1.2})
...
//		String schoolMasks;
	...
	public static void main(String[] args) {
		String[] args2 = {
				RunParallel.OPTION_SETUP, BMBF210903_copy_update.class.getName(),
